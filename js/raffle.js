...
class Raffle {
    constructor(){
        ...
        this.students = _.shuffle([
            ...
            { name: 'Elena', img: './img/elena.jpg', ta:[this.esther,this.alba] },
            { name: 'Eva C.', img: './img/eva_c.jpg', ta:[this.jose, this.alba] },
            { name: 'Eva S.', img: './img/eva_s.jpg', ta:[this.esther,this.jose] },
            { name: 'Gabriela', img: './img/gabriela.jpg', ta:[this.jose, this.alba,this.luis ] },
            { name: 'Guillermo', img: './img/guillermo.jpg', ta:[this.esther, this.luis] },
            { name: 'Isabel', img: './img/isabel.jpg', ta:[this.jose, this.esther, this.luis] },
            { name: 'Javi', img: './img/javi.jpg', ta:[this.esther, this.luis] },
            { name: 'Karla', img: './img/karla.jpg', ta:[this.alba, this.luis] },
